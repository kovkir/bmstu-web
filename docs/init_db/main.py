...
class FootballDB:
    ...
    def drop_tables(self):
        try:
            self.__cursor.execute(
                ...
                DROP TABLE public."Club", public."Coach", public."Player", public."Squad", public."User", public."SquadPlayer", public."Agent", public."__EFMigrationsHistory"
                """
            )
    ...
    def copy_data(self):
        self.__cursor.execute(
                ...
                copy public."Agent"("PlayerId", "Surname", "Country")                   from '/Users/Shared/tables/agent.csv'  delimiter ',' csv;
                """
            )
